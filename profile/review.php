        ...
        <div class="body animated slow fadeIn">
            ...
            for ($i = 1; $i <= $_SESSION['number'] - 1; $i++) {
                ...
                <div class="medium" style="padding-top: 0">
                    <?php echo "<b>".$_SESSION['topic'].":</b>"." <i>Problems ".mb_substr($_SESSION['topic'], 0, 1)."1 &ndash; ".mb_substr($_SESSION['topic'], 0, 1).($_SESSION['number'] - 1)."</i>";?>
                </div>
                <hr>
                <p class="regular" id="math" style="padding-top: 1em;">
            ...
            <hr>
            <p class="regular" id="math" style="min-height: 25vh; padding-top: 1em;">
                <?php echo $_SESSION['text']; ?>
            </p>
